document.addEventListener("DOMContentLoaded", function () {
    ...
    const csvFileName = `SalesOrdersCreatedbyDateRangebyCounterPerson-1738788821-385860130.csv`;
    ...
    function processFile(file) {
        if (file.name.includes('SalesOrdersCreatedbyDateRangebyCounterPerson')) {
            ...
            errorMessage.textContent = `Invalid file selected. Please upload a file named like "SalesOrdersCreatedbyDateRangebyCounterPerson.csv".`;
